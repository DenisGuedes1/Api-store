...
import { TcreatedUser,TreturnCreateUser} from "../../interface/interfaceProducts";
export const createdUserService = async(userData:TcreatedUser): Promise<TreturnCreateUser> =>{
