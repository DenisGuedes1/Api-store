...
userRouter.post("/login", (0, middlewares_1.validateDataMiddleware)(schema_user_1.loginUserSchema), loginUser_controler_1.loginUserController);
userRouter.post("/user/addres", middlewares_1.veriFyTokenIsValid, createdAdress_controller_1.createdAddresController);
userRouter.post("/users/reset-password", sendReseteEmailPassword_1.sendEmailResetPasswordController);
userRouter.get("/list-users", getAllusers_1.getAllUserController);
userRouter.delete("/users/delete", middlewares_1.veriFyTokenIsValid, deleteUser_controller_1.deleteUserController);
